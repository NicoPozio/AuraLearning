...
export class AffectAnalyzer {
    constructor(loggerCallback) {
        ...
        this._MEs = {
            browFurrow:  { zThresh: 1.2, durationMs: 2500, deactivateMs: 1500, _sinceMs: 0, _offSinceMs: 0, active: false },
            eyeSquint:   { zThresh: 1.1, durationMs: 1800, deactivateMs: 1200, _sinceMs: 0, _offSinceMs: 0, active: false },
            lipPress:    { zThresh: 1.5, durationMs: 2000, deactivateMs: 1200, _sinceMs: 0, _offSinceMs: 0, active: false },
            mouthOpen:   { zThresh: 1.8, durationMs: 1800, deactivateMs: 1000, _sinceMs: 0, _offSinceMs: 0, active: false },
            mouthFrown:  { zThresh: 1.1, durationMs: 1800, deactivateMs: 1500, _sinceMs: 0, _offSinceMs: 0, active: false },
            noseWrinkle: { zThresh: 1.2, durationMs: 1800, deactivateMs: 1000, _sinceMs: 0, _offSinceMs: 0, active: false },
            browRaise:   { zThresh: 1.2, durationMs: 2000, deactivateMs: 1200, _sinceMs: 0, _offSinceMs: 0, active: false },
